...
class MainCardsAdapter(private val context: Context, private val cards: List<MainCard>, private val gridUpdater: IGridUpdater) : StaticCardsAdapter(context, cards) {
