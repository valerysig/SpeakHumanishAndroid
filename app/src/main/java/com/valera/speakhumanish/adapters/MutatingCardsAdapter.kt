...
class MutatingCardsAdapter(private val context: Context, cards: List<Card>, private val gridUpdater: IGridUpdater, backgroudColor : String? = null) : CardsAdapter(context, cards, backgroudColor) {
